...
class MultiRegionActivator:
    ...
    def major_login(self, access_token, open_id, region='IND'):
        ...
        OLD_ACCESS_TOKEN = b"c69ae208fad72738b674b2847b50a3a1dfa25d1a19fae745fc76ac4a0e414c94"
    ...
    def GET_PAYLOAD_BY_DATA(self, JWT_TOKEN, NEW_ACCESS_TOKEN, region='IND'):
        try:
            ...
            payload = bytes.fromhex("")
            payload = payload.replace(b"2025-11-26 01:51:28", now.encode())
            ...
            payload = payload.replace(b"4306245793de86da425a52caadf21eed", SIGNATURE_MD5.encode("UTF-8"))
            PAYLOAD = payload.hex()
 ...
 #sb       
    ...
    def save_results(self):
        try:
            ...
            success_file = f'success-{region_name}.json'
            failed_file = f'failed-{region_name}.json'
